...
%PENDING: Specific which chemical recycling are we doing
...
As previously mentioned, traditional multi-life cycle analyses have previously leaned into reporting reuse and recycling practices almost indistinctly.
...
Consequently, emission can be directly deducted on the scale of the amount that is recycled.
However, even if simpler, this approach leaves out of sight differentiating attributes on specific methodologies.
...
Meanwhile second-life material retrieve from a mechanical technique will be reintroduce on the production phase, the pyrolitics
This of course is related to the (technological limitation/ output/ results prone to the type of technology)
Yet, for a product systems perspective
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{\fontfamily{cmss}\selectfont
{"A similar distintion ocuurs on the disposal phase..."
}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
