...
As seen from the figure, the reintroduction of repurposed material is different in both the stages and process.
Meanwhile the product of mechanical recycling is typically reintroduced directly on to the molding process, the liquid pyrolitic stream replaces the use of material at the cracking process, much closer to the raw material form.
Said differently, by being unique on their material properties these two methodologies will undoubtedly result on distinctive accounts of the energy inputs required to furnish each of the recycled products.
...
It is also at this point where the individual product systems are set apart and undertake the remanufacturing function utterly differently.
The circled numbers across \autoref{fig:zoom} and \autoref{fig:5Disposal} serve to identify this specific product streams and will, in due course, designate the material properties and mass balance across the life cycle modeling.
...
According to the ISO 14044:2006, the functional unit is understo
