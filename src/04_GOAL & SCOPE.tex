...
As can be, although the comparing product system aggregates disparate amounts of unit processes, both are limited to the triple cycle requirement and have been set a boundary that excludes those processes not related to the recycling itself.
