...
Although predominantly related to the natural environment, it may be also tailored to include the accounting of social and economic effect while evaluating their plausible trade-offs. \cite{Hauschild2018, ISO14044:2006}

%TOPIC: The LCA Languaje %FIGURE: LINEAR LIFE CYCLE
\autoref{fig:1} shows an schematic interpretation of the LCA approach.
...
Withal, inside this stages are considered the several unit processes which are responsible of transforming the inputs into outputs.
Depicted in black, in between the stages, are the reference flows.
These are respective to a measure of those outputs from any process or stage which continue advancing trough the life cycle and are required for fulfilling the function of the functional unit.
Altogether, this collection of unit process and product flows in tandem with their interactions is referred a product system.
...
\autoref{fig:2} serves to expose both the recycle feature but also the endmost disparity this change would on have on the quantitative analysis.
