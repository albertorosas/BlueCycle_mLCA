...
%TOPIC: About an mLCA
Although not always referred as mLCA, Suharinyanto et al.~\cite{Suhariyanto2017} demonstrated there has been an increased interest across literature on the development of life cycle analyses which include stage like remanufacturing, reusing and recycling inside their system boundaries.
...
However, these were most commonly regarded to products with low technological discontinuance, could be easily resold or provided with a second life utilization (reuse).
